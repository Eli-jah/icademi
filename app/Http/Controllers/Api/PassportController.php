...
class PassportController extends Controller
{
    ...
    /**
     * @api {post} /api/register User Register API
     * @apiName User Register API
     * @apiGroup Passport
     * @apiVersion 0.1.0
     *
     ...
     * @apiParam {String} confirm_password Comfirm User's password.
     *
    ...
    /**
     * @api {post} /api/login General Login API
     * @apiName General Login API
     * @apiGroup Passport
     * @apiVersion 0.1.0
     *
    ...
    /**
     * @api {get} /api/info User Info API
