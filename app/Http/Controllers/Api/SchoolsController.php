...
class SchoolsController extends Controller
{
    ...
    /**
     * @api {get} /api/school/teachers 2. School Teacher List API
    ...
    /**
     * @api {get} /api/school/all_students 7. School All Student List API
     * @apiName 7. School All Student List API
     * @apiGroup Teacher
     * @apiVersion 0.1.0
     *
     * @apiParam {Integer} school_id School's unique ID.
     ...
     * @apiSuccess {Datetime} response.data.type User type: student.
     *
     * @apiSuccessExample Success-Response:
     *     HTTP/1.1 200 OK
     *     {
    ...
    /**
     * @api {get} /api/school/fans_students 8. School Fans Student List API
     * @apiName 8. School Fans Student List API
     * @apiGroup Teacher
     * @apiVersion 0.1.0
     *
     * @apiParam {Integer} school_id School's unique ID.
     ...
     *
     */
    public function fansStudents(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'school_id' => 'required|integer|exists:schools,id',
        ]);
