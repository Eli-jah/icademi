define({ "api": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "response.data.ws_token",
            "description": "<p>Websocket Token.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "title": "4. General Logout API",
    "name": "4._General_Logout_API",
    "group": "Passport",
    "version": "0.1.0",
    "header": {
      "fields": {
  ...
  },
  {
    "type": "post",
    "url": "/api/ws/contacts",
    "title": "1. Contact List API",
    "name": "1._Contact_List_API",
    "group": "Websocket",
    "version": "0.1.0",
    "parameter": {
      "fields": {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "response.data.type",
            "description": "<p>Contact's type.</p>"
          }
        ]
      },
      "examples": [
    ...
    "filename": "app/Http/Controllers/Api/WSController.php",
    "groupTitle": "Websocket"
  },
  {
    "type": "post",
    "url": "/api/ws/chat_history",
    "title": "2. Chat History API",
    "name": "2._Chat_History_API",
    "group": "Websocket",
    "version": "0.1.0",
    "parameter": {
      "fields": {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "response.data.created_at",
            "description": "<p>sent_at of message.</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "content",
            "description": "<p>Chat message content.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/ws/refresh_ws_token",
    "title": "4. Refresh WS Token API",
    "name": "4._Refresh_WS_Token_API",
    "group": "Websocket",
    "version": "0.1.0",
    "parameter": {
      "fields": {
